    ...
    <div class="min-h-screen flex items-center justify-center bg-secondary-50 px-4">
        <div class="max-w-md w-full bg-white p-8 rounded-xl shadow-xl border border-secondary-200">
            ...
            <div class="text-center mb-8">
                <div
                    class="inline-flex items-center justify-center w-32 h-32 rounded-full mb-4 overflow-hidden">
                ...
                <p class="text-sm text-secondary-400 mt-2">Direccion Nacional de Bomberos</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5" novalidate>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}"
                        class="text-sm text-primary-5 hover:text-primary-6 font-medium hover:underline">
            ...
            btn?.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (!success) {
                        ...
                        let errorMsg = error ??
                            "No se pudo autenticar con Passkey. Verifica tu dispositivo.";

                        if (error && error.includes('AssertionCancelled')) {
                            errorMsg =
                            "Autenticación cancelada. Intenta nuevamente cuando estés listo.";
