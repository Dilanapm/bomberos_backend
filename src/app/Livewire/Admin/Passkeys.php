...
class Passkeys extends Component
{
    ...
    public function revoke(string $credentialId): void
    {
        ...
        // Eliminar permanentemente — passkeys son opcionales, no hay restricción mínima
        $credential->forceDelete();

        $this->dispatch('notify', type: 'success', message: 'Passkey eliminada. Puedes registrar una nueva cuando quieras.');
        $this->syncAliases();
    }
